...
4. **Sprawy frankowiczów (kredyty CHF):**
   ...
   - Skill `law-pl-applying-frankowicze-case-law`.
...
**Poza zakresem** — sprawy B2B (→ zwykły `law-pl-claim-drafter`), spory karne (→ `law-pl-criminal-complaint-drafter`), sprawy pracownicze (→ `law-pl-labor-drafter`).
...
3. **Termin przedawnienia** (skill `law-pl-checking-przedawnienie`):
...
5. **Opłaty:**
   - **Zwykły pozew cywilny** — opłata stosunkowa lub stała (skill `law-pl-calculating-oplata-sadowa`).
...
## Frankowicze — kluczowe orzeczenia (przez skill `law-pl-applying-frankowicze-case-law`)
...
- **Orzecznictwo TSUE** — curia.europa.eu; skill `law-pl-applying-frankowicze-case-law`.
...
- Na końcu — **Lista kontrolna dla prawnika**:
  ...
  - [ ] Dla frankowiczów — aktualne orzecznictwo TSUE i SN (skill `law-pl-applying-frankowicze-case-law`)
