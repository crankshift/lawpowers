...
# Agent: law-pl-enforcement-agent
...
**Poza zakresem** — postępowania sądowe o zasądzenie przed otwarciem egzekucji (`law-pl-debt-collector`, `law-pl-claim-drafter`), zaskarżanie aktów notarialnych, postępowanie restrukturyzacyjne i upadłościowe (osobne specjalizacje).
