...
- Wezwania umowne → przekazanie do `law-pl-debt-collector` / `law-pl-claim-drafter`.
...
**Poza zakresem** — postępowania sądowe na podstawie umowy (`law-pl-claim-drafter`, `law-pl-response-drafter`), windykacja należności w pełnym cyklu (`law-pl-debt-collector`).
...
- [ ] Zakaz konkurencji (B2B) — proporcjonalność, kompensacja, czas, zakres (zob. skill `law-pl-reviewing-b2b-service-contract`)
...
Pełny checklist i red flags → skill **[`law-pl-reviewing-b2b-service-contract`](../../skills/pl/law-pl-reviewing-b2b-service-contract/SKILL.md)**.
...
- **[`law-pl-reviewing-vehicle-contract`](../../skills/pl/law-pl-reviewing-vehicle-contract/SKILL.md)** — checklist + red flags dla umów sprzedaży pojazdów (VIN, CEPiK, PCC-3, stany nadzwyczajne).
- **[`law-pl-reviewing-real-estate-contract`](../../skills/pl/law-pl-reviewing-real-estate-contract/SKILL.md)** — checklist + red flags dla umów na nieruchomościach (KW, hipoteki, służebności, prawo pierwokupu, zadatek vs. zaliczka, forma aktu notarialnego).
- **[`law-pl-searching-krs`](../../skills/pl/law-pl-searching-krs/SKILL.md)** — weryfikacja strony-osoby prawnej (reprezentacja, upadłość, biała lista VAT).
- **[`law-pl-applying-rodo`](../../skills/pl/law-pl-applying-rodo/SKILL.md)** — wymogi dla klauzul przetwarzania i umowy powierzenia (art. 28 RODO).
- **[`law-pl-reviewing-b2b-service-contract`](../../skills/pl/law-pl-reviewing-b2b-service-contract/SKILL.md)** — checklist + red flags dla umów B2B (zakaz konkurencji, wyłączność, kary umowne, IP, pozorny stosunek pracy).
