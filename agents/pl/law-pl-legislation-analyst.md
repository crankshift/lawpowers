---
name: law-pl-legislation-analyst
...
# Agent: law-pl-legislation-analyst
...
**Poza zakresem** — sporządzanie pism procesowych (`law-pl-claim-drafter`), wniosków (`law-pl-request-drafter`).
