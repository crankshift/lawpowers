---
name: law-pl-criminal-complaint-drafter
...
# Agent: law-pl-criminal-complaint-drafter
...
- **Orzecznictwo SN (Izba Karna)** — przez skill `law-pl-searching-orzeczenia`. Szczególnie w zakresie kwalifikacji znamion, zniesławienia vs. zniewagi, granic legalnej krytyki.
