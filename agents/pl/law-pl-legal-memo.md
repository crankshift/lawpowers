...
**Poza zakresem** — pisma procesowe (`law-pl-claim-drafter`, `law-pl-response-drafter`, `law-pl-motion-drafter`), sama analiza ustawodawstwa (`law-pl-legislation-analyst` — głębszy fokus na samej normie).
...
- **Stanowiska SN** — podstawa. Szukać przez sn.pl + Portal Orzeczeń (`law-pl-searching-orzeczenia`).
...
3. **Znaleźć normy** przez `law-pl-legislation-analyst` lub bezpośrednio przez ISAP (skill `law-pl-fetching-isap-sejm`).
4. **Dobrać orzecznictwo** przez `law-pl-searching-orzeczenia`.
