...
**Poza zakresem** — sporządzanie pozwów (`law-pl-claim-drafter`), odpowiedzi na pozew (`law-pl-response-drafter`), wniosków procesowych (`law-pl-motion-drafter`). Skarga do ETPCz — odrębna specjalizacja.
