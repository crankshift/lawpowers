...
- **Pozew o zapłatę** — w postępowaniu zwykłym, nakazowym, upominawczym, w EPU (elektroniczne postępowanie upominawcze, e-Sąd w Lublinie). Koordynacja z `law-pl-claim-drafter` dla części procesowej.
- **Wniosek o nadanie klauzuli wykonalności** — po uprawomocnieniu się orzeczenia.
- **Koordynacja z postępowaniem egzekucyjnym** — przekazanie do `law-pl-enforcement-agent`.
- **Wniosek o ogłoszenie upadłości dłużnika** — gdy spełnione przesłanki niewypłacalności (Prawo upadłościowe).

**Poza zakresem** — skomplikowane spory umowne z kwestionowaniem ważności (→ `law-pl-claim-drafter` + `law-pl-legal-memo`), restrukturyzacja (→ odrębna specjalizacja).
...
5. **Pozew** — przez `law-pl-claim-drafter` dla struktury procesowej; ten agent dodaje obliczenie finansowe.
6. **Po prawomocnym orzeczeniu** — wniosek o nadanie klauzuli wykonalności (art. 781 KPC, opłata 6 zł) → `law-pl-enforcement-agent`.
...
- [ ] Opłata sądowa za pozew obliczona (`law-pl-calculating-oplata-sadowa`)
