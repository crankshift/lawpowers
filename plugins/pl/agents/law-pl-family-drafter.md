...
**Poza zakresem** — sprawy spadkowe (→ `law-pl-inheritance-drafter`), przemoc w rodzinie w trybie karnym (→ `law-pl-criminal-complaint-drafter`), świadczenia z pomocy społecznej, ekspertyzy psychologiczne / OZSS (to czynność sądu, nie pełnomocnika).
...
3. **Opłata sądowa** (skill `law-pl-calculating-oplata-sadowa`):
...
4. **Terminy**:
   ...
   - **Przedawnienie roszczeń alimentacyjnych** — 3 lata (alimenty są świadczeniami okresowymi — art. 118 KC); skill `law-pl-checking-przedawnienie`.
...
6. **Alimenty — szczegółowo** (skill `law-pl-calculating-alimenty`):
...
- **Orzecznictwo SN** — szczególnie w sprawach o wpływ winy na alimenty, przesłanki rozwodu, ograniczenie władzy rodzicielskiej. Przez skill `law-pl-searching-orzeczenia`.
