---
name: law-ua-reviewing-real-estate-contract
...
# law-ua-reviewing-real-estate-contract
...
- Для повного складання договору купівлі-продажу чи попереднього договору — агент `law-ua-contract-drafter` (режим складання).
- Для перевірки продавця-юр. особи — ЄДР через usr.minjust.gov.ua (офіційний відкритий реєстр) + виконавчі провадження.
- Для спору про визнання договору недійсним — агент `law-ua-claim-drafter` (позов за ст. 215-236 ЦК).
- Для спадкових питань — зазвичай спадкова справа в нотаріуса; судовий спір — агент `law-ua-claim-drafter`.
- Для сімейних питань (подружня згода, режим майна) — ст. 60–74 СК + позов за ст. 65 СК (визнання правочину недійсним).
- Для перевірки воєнних обмежень — скіл `law-ua-checking-martial-law-overrides`.
