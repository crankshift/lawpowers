...
- **No liability.** To the maximum extent permitted by law, neither Anthropic (the provider of Claude), nor the authors, maintainers, or contributors of this repository, will be liable for any direct, indirect, incidental, consequential, special, or exemplary damages arising from the use of, or inability to use, this software — including but not limited to damages resulting from erroneous drafts, missed deadlines, misquoted statutes, adverse rulings, or any other legal or financial consequence. You use these plugins entirely at your own risk.
